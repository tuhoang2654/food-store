...
<style type="text/css">
	body{
		margin: 0;
		padding: 0;
		background-color:rgb(139, 209, 134);
	}
	#form{
...
?>
	<form method="post" accept-charset="utf-8">
		<div id="form">
			...
			?>
			<div>
				<input class="btn_rgt" style="background-color: blue;border: 1px black solid;border-radius: 50%" type="submit" name="submit" value="Đăng nhập">
			</div>
		</div>
	</form>
</body>
