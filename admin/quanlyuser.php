											...
											<tr>
										      	...
										      	<td  style="text-align: center;width:">
										      		<a href="resert_password.php?id=<?php echo $makh;?>">
										      			<img style="width:2cm;height:2cm" src="../IMAGES/reset_mk.jpg" class="img_tbl1">
										      		</a>
										      	</td>
										      	<td  style="text-align: center;">
										      		<a href="edit_user.php?id=<?php echo $makh;?>">
														<img style="width:2cm;height:2cm" src="../IMAGES/icon_edit.png" class="img_tb1">
													</a>
										      	</td>
										      	<td style="text-align: center;">
										      		<a href="khoa_user.php?id=<?php echo $makh;?>">
										      			<img style="width:2cm;height:2cm" src="../IMAGES/doi_mk.png" class="img_tb1">
										      		</a>
										      	</td>
									     	</tr>
									<?PHP }?>
